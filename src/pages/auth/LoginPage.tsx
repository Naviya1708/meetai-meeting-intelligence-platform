    ...
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div>
            ...
            <p className="text-slate-300 text-lg leading-relaxed">
              AI-powered summaries, action items, decisions, and searchable knowledge from every conversation.
            </p>
            <div className="mt-8 flex items-center gap-2 text-sm text-slate-300">
              <Sparkles className="w-4 h-4" />
              <span>Trusted by teams to make meetings productive</span>
            </div>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-slate-50">
        <div className="w-full max-w-md">
          ...
          <p className="text-slate-500 mb-8">Welcome back. Let's make your meetings smarter.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              {loading ? <Spinner className="w-4 h-4" /> : <>Sign in <ArrowRight className="w-4 h-4" /></>}
            </button>
          </form>
